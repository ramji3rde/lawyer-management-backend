...
exports.viewSpecific = (req, res) => {
    ...
    Communication.find({ userId: req.params.id }).populate("matter to").
        then(data => {
            res.status(200).json({ status: true, message: "Communication fetched", data })
...
exports.viewForMatter = (req, res) => {
    ...
    Communication.find({ userId: req.params.id, matter: req.params.matter }).populate("matter to").
        then(data => {
            res.status(200).json({ status: true, message: "Communication fetched", data })
...
exports.viewSpecificCommunicationClient = (req, res) => {
    ...
    Communication.find({ userId: req.params.id, from: req.params.contact }).populate("matter to")
        .then(data => {
...
exports.sendEmail = (req, res) => {
    ...
    var mailOptions = {
        ...
        text: req.body.text ? req.body.text : "", // plain text body
        html: req.body.html ? req.body.html : "<div></div>", // html body
    };
